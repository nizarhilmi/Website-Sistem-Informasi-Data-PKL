			...
			<section class="about-generic-area section-gap">
				<div class="container border-top-generic">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="img-text">
								<img src="img/logofixdong.png" alt="" class="img-fluid float-left mr-20 mb-20">
								<center>
									<h3>Magang.id</h3>
								</center>
								<p><br>
									<center>
										Magang.id merupakan project dari kelompok yang beranggotakan Nizar Hilmi, 
										Adzan Bari Naufal, Tamia Kristina Natalia dimana ketiganya adalah mahasiswa 
										Institut Teknologi Telkom Purwokerto. Website ini mengusung tema Sistem Informasi Data PKL 
										yang bertujuan untuk memudahkan dan memberikan informasi kepada mahasiswa yang akan 
										melaksanakan kegiatan PKL sehingga mengetahui informasi berupa list perusahaan yang dapat
										dijadikan tempat PKL dan terdapat pelayanan untuk membuat surat pengantar PKL dan 
										Magang langsung dari Institut Teknologi Telkom Purwokerto
									</center>
								</p>                			
							</div>
						</div>
